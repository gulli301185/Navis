...
import { AccardionInfo } from "../../constants";
    ...
    <div className="container py-40 mx-auto">
      ...
      <div className="grid grid-cols-3  gap-20 ">
        <CardMain className="h-[545px]  bg-gradient-to-bl to-red-700 from-orange-600 relative ">
          ...
          <h1 className="text-2xl text-white w-72 text-start font-semibold">Интегрированная платформа обеспечения соответвия</h1>
          <p className="text-gray-100 text-start  w-72 text-lg">AMLBot автоматизирует AML / KYC процедуры и снижает расходы </p>
            </div>
          <img src={Mental} width="407px" alt="" className=" absolute -bottom-4"/>
        </CardMain>
        <div className="col-span-2">
          {AccardionInfo.map((info,index) => (
