...
const InfoCard = () => {
  return (
    <div className="container mx-auto">
      <h1 className="pb-5 font-semibold text-4xl text-center">Почему AMLnavis?</h1>
        ...
        <div className="h-full w-full bg-gray-100 rounded-lg ">
          ...
          <div className="w-[505px] text-start mx-auto text-xl text-gray-500 pb-8">
            ...
            <p className="">
              ...
              ваши требования, ведь мы помогли 300+ криптовалютным
              организациям всех размеров в 25 юрисдикциях.
            </p>
          </div>
        </div>
        <div className="flex flex-col gap-3 h-full w-full">
          ...
          <div className=" flex w-full gap-3">
            ...
            <img src={likeIcon} alt="" className="py-6" />
              <h1 className=" text-[40px] font-bold uppercase text-white ">+8k</h1>
              <p className="text-[15px]  text-gray-200 pb-8 ">провайдеров <br />проверенo</p>
            </div>
            <div className=" text-start pl-10 w-full  bg-orange-700 rounded-xl">
            <img src={starIcon} alt="" className="py-6" />
              <h1 className=" text-[40px] font-bold uppercase text-white ">ISO <div className="text-lg font-semibold  leading-loose">сертификация</div></h1>
              <div className="flex relative">

              <p className="text-[15px]  text-gray-200 pb-8 ">узнать больше</p>
              <img src={showIcon} alt="" className="absolute left-52 bottom-8" />
              </div>
            </div>
